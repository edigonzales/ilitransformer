...
Die vollständige Demo-Suite (`demo/`) enthält zehn Beispiele, die sich von einfachen Kopierregeln bis zu Referenzen, BAG OF STRUCTURE und OID-Strategien steigern. Siehe xref:_beispiele[Anhang C] für die kompletten Listings.

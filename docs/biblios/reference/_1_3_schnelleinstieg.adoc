...
Die vollständige Demo-Suite (`demo/`) enthält zehn Beispiele, die sich von einfachen Kopierregeln bis zu Referenzen, BAG OF STRUCTURE und OID-Strategien steigern. Anhang C enthält dazu ausgewählte vollständige Minimalbeispiele; die kompletten Demo-Dateien liegen unter `demo/`.

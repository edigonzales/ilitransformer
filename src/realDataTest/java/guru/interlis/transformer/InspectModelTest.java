...
class InspectModelTest {
    ...
    void printDmavBodenbedeckungTables() {
        inspectTable("DMAV_Bodenbedeckung_V1_1", MODEL_DIR + ";https://models.interlis.ch",
                "DMAV_Bodenbedeckung_V1_1.Bodenbedeckung", "Bodenbedeckung");
        inspectTable("DMAV_Bodenbedeckung_V1_1", MODEL_DIR + ";https://models.interlis.ch",
                "DMAV_Bodenbedeckung_V1_1.Bodenbedeckung", "Objektnummer");
        inspectTable("DMAV_Bodenbedeckung_V1_1", MODEL_DIR + ";https://models.interlis.ch",
                "DMAV_Bodenbedeckung_V1_1.Bodenbedeckung", "Symbolposition");
        inspectTable("DMAV_Bodenbedeckung_V1_1", MODEL_DIR + ";https://models.interlis.ch",
                "DMAV_Bodenbedeckung_V1_1.Bodenbedeckung", "Textposition");
    }

    @Test
    void printDm01BoFlaecheTables() {
        inspectTable("DM01AVCH24LV95D", MODEL_DIR,
                "DM01AVCH24LV95D.Bodenbedeckung", "BoFlaeche");
        inspectTable("DM01AVCH24LV95D", MODEL_DIR,
                            ...
                            if (domain != null) {
                                ...
                                try {
                                    if (domain.getClass().getSimpleName().contains("BagOf")
                                        ...
                                        Object comp = domain.getClass().getMethod("getComponentType").invoke(domain);
                                        if (comp != null) {
                                ...
                                try {
                                    if (domain.getClass().getSimpleName().contains("Reference")) {
                                        Object ref = domain.getClass().getMethod("getReferred").invoke(domain);
                                        if (ref != null) {

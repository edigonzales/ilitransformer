...
class WrongArgumentTypeCompileTest {
    ...
    void wrongArgTypeProducesWarning() {
        ...
        assertThat(diagnostics.all()).anyMatch(d -> d.code().equals(DiagnosticCode.EXPR_WRONG_ARG_TYPE));
    }
    ...
    void compatibleTypesDoNotWarn() {
        ...
        assertThat(diagnostics.all()).noneMatch(d -> d.code().equals(DiagnosticCode.EXPR_WRONG_ARG_TYPE));
    }
}
